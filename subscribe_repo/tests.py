...
class SubscribeRepoClass(TestCase):
    ...
    def test_val_state(self):
        ...
        rec = Record('1', 'first', 'last', 'addr', 'NY', '12345', 'status', '1', 'prod_name', '12.34', '2021-02-05T16:30Z')
    ...
    def test_val_zip(self):
        ...
        rec = Record('1', 'first', 'last', 'addr', 'NY', '1234', 'status', '1', 'prod_name', '12.34', '2021-02-05T16:30Z')
        expected_result = False
        cust = Customer()
        actual_result = cust.val_zip(rec)
        self.assertEqual(expected_result, actual_result)
        ...
        rec = Record('1', 'first', 'last', 'addr', 'NY', 'ABCD5', 'status', '1', 'prod_name', '12.34', '2021-02-05T16:30Z')
        expected_result = False
        cust = Customer()
        actual_result = cust.val_zip(rec)
        self.assertEqual(expected_result, actual_result)
        ...
        rec = Record('1', 'first', 'last', 'addr', 'NY', 'ABCD', 'status', '1', 'prod_name', '12.34', '2021-02-05T16:30Z')
        expected_result = False
        cust = Customer()
        actual_result = cust.val_zip(rec)
        self.assertEqual(expected_result, actual_result)
    ...
    def test_valid_dates(self):
        ...
        rec = Record('1', 'Snake', 'Plisken', '123 Fake St.', 'AZ', '12345', 'new', '432', 'Masthead', '100.12',
                '2021-02-05T16:30Z')
    ...
    def test_valid_status(self):
        ...
        # customer has invalid status
        rec = Record('1', 'Snake', 'Plisken', '123 Fake St.', 'AZ', '12345', 'Blah', '432', 'Masthead', '100.12',
                     '2021-02-05T16:30Z')
        expected_result = False
        actual_result = cust.val_status(cust, rec)
        self.assertEqual(actual_result, expected_result)
        ...
        rec = Record('1', 'Snake', 'Plisken', '123 Fake St.', 'AZ', '12345', 'canceled', '432', 'Masthead', '100.12',
                '2021-02-05T16:30Z')
        expected_result = True
        actual_result = cust.val_status(cust, rec)
        self.assertEqual(actual_result, expected_result)
    ...
    def test_parse_data(self, mock_check_for_customer, mock_create_update_cust):
        ...
        infile = [b'1\tSnake\tPlisken\t123 Fake St.\tAZ\t12345\tnew\t432\tMasthead\t100.12\t2007-04-03T14:30Z\n']
        cust = Customer()
        ...
        infile = [b'1\tSnake\tPlisken\t123 Fake St.\tAZ\t12345\tcanceled\t432\tMasthead\t100.12\t2007-04-03T14:30Z\n']
        cust = Customer()
        mock_check_for_customer.return_value = cust
        ...
        infile = [b'1\tSnake\tPlisken\t123 Fake St.\tAZ\t12345\tnew\t432\tMasthead\t100.12\t2021-02-05T16:30Z\n']
        cust = Customer()
        cust.cust_id = 1
        cust.cust_change_in_purchase_status = 'new'
        ...
        infile = [b'1\tSnake\tPlisken\t123 Fake St.\tAZ\t12345\tcanceled\t432\tMasthead\t100.12\t2021-02-05T16:30Z\n']
        cust = Customer()
        cust.cust_id = 1
        cust.cust_change_in_purchase_status = 'canceled'
        cust.mod_date = parser.isoparse('2021-02-04T16:30Z')
        ...
        infile = [b'1\tSnake\tPlisken\t123 Fake St.\tAZ\t12345\tcanceled\t432\tMasthead\t100.12\t2021-02-03T16:30Z\n']
        cust = Customer()
        cust.cust_id = 1
        cust.cust_change_in_purchase_status = 'new'
        cust.mod_date = parser.isoparse('2021-02-04T16:30Z')
        ...
        mock_check_for_customer.return_value = cust
        actual_dict, actual_processed = helpers.parse_subs(infile)
        expected_dict = {'1': ['current mod date <= date on update record', 'status is inconsistant']}
        self.assertDictEqual(actual_dict, expected_dict)
        self.assertEqual(expected_processed, actual_processed)

        # customer doesn't exist All data is good
        infile = [b'1\tSnake\tPlisken\t123 Fake St.\tAZ\t12345\tnew\t432\tMasthead\t100.12\t2021-02-03T16:30Z\n']
        cust = Customer()
        mock_check_for_customer.return_value = cust
        actual_dict, actual_processed = helpers.parse_subs(infile)
        expected_dict = {}
